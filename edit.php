...
session_start();
    ...
    if ( $_SERVER['REQUEST_METHOD'] === "POST" ) 
    {
        ...
        $_SESSION['success'] = "<em>$film[name]</em> a été modifié avec succès.";
    ...
    // Afficher la vue de modification du film
?>
<?php $title = "Modification du film"; ?>
<?php $description = "Modification du film"; ?>
